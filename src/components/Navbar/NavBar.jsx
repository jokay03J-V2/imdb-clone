    ...
    return (
        <nav className="w-full bg-neutral-900 h-16 flex justify-start items-center text-4xl relative">
            ...
            <ul className="w-full h-16 flex items-center justify-between list-none">
                <li className="h-16 flex items-center justify-center"><img src="https://upload.wikimedia.org/wikipedia/commons/6/69/IMDB_Logo_2016.svg" className="h-3/4 py-1 mr-4" onClick={() => navigate("/")}></img></li>
